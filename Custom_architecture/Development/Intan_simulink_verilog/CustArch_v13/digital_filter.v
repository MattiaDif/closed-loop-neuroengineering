// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v13\digital_filter.v
...
// Source Path: CustArch_v13/cust_architecture/process_and_retrieve/Filter_ch1/digital_filter
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module digital_filter
  ...
  wire signed [31:0] Add_out1 [0:7];  // sfix32_En16 [8]
  wire signed [31:0] highpass_out1_0;  // sfix32_En20
  wire signed [31:0] highpass_out1_1;  // sfix32_En20
  wire signed [31:0] highpass_out1_2;  // sfix32_En20
  wire signed [31:0] highpass_out1_3;  // sfix32_En20
  wire signed [31:0] highpass_out1_4;  // sfix32_En20
  wire signed [31:0] highpass_out1_5;  // sfix32_En20
  wire signed [31:0] highpass_out1_6;  // sfix32_En20
  wire signed [31:0] highpass_out1_7;  // sfix32_En20
  wire signed [31:0] highpass_out1 [0:7];  // sfix32_En20 [8]
  wire [15:0] Constant1_out1;  // uint16
  wire signed [37:0] Add1_v;  // sfix38_En20
  wire signed [37:0] Add1_add_cast;  // sfix38_En20
  wire signed [37:0] Add1_add_temp;  // sfix38_En20
  wire signed [37:0] Add1_add_cast_1;  // sfix38_En20
  wire signed [37:0] Add1_add_temp_1;  // sfix38_En20
  wire signed [37:0] Add1_add_cast_2;  // sfix38_En20
  wire signed [37:0] Add1_add_temp_2;  // sfix38_En20
  wire signed [37:0] Add1_add_cast_3;  // sfix38_En20
  wire signed [37:0] Add1_add_temp_3;  // sfix38_En20
  wire signed [37:0] Add1_add_cast_4;  // sfix38_En20
  wire signed [37:0] Add1_add_temp_4;  // sfix38_En20
  wire signed [37:0] Add1_add_cast_5;  // sfix38_En20
  wire signed [37:0] Add1_add_temp_5;  // sfix38_En20
  wire signed [37:0] Add1_add_cast_6;  // sfix38_En20
  wire signed [37:0] Add1_add_temp_6;  // sfix38_En20
  wire signed [37:0] Add1_add_cast_7;  // sfix38_En20
  wire signed [37:0] Add1_add_temp_7;  // sfix38_En20
  ...
  assign Add_out1[0] = {Add_sub_temp[15:0], 16'b0000000000000000};
  assign Add_2 = {1'b0, raw_input[1]};
  assign Add_sub_temp_1 = Add_2 - Add_v;
  assign Add_out1[1] = {Add_sub_temp_1[15:0], 16'b0000000000000000};
  assign Add_3 = {1'b0, raw_input[2]};
  assign Add_sub_temp_2 = Add_3 - Add_v;
  assign Add_out1[2] = {Add_sub_temp_2[15:0], 16'b0000000000000000};
  assign Add_4 = {1'b0, raw_input[3]};
  assign Add_sub_temp_3 = Add_4 - Add_v;
  assign Add_out1[3] = {Add_sub_temp_3[15:0], 16'b0000000000000000};
  assign Add_5 = {1'b0, raw_input[4]};
  assign Add_sub_temp_4 = Add_5 - Add_v;
  assign Add_out1[4] = {Add_sub_temp_4[15:0], 16'b0000000000000000};
  assign Add_6 = {1'b0, raw_input[5]};
  assign Add_sub_temp_5 = Add_6 - Add_v;
  assign Add_out1[5] = {Add_sub_temp_5[15:0], 16'b0000000000000000};
  assign Add_7 = {1'b0, raw_input[6]};
  assign Add_sub_temp_6 = Add_7 - Add_v;
  assign Add_out1[6] = {Add_sub_temp_6[15:0], 16'b0000000000000000};
  assign Add_8 = {1'b0, raw_input[7]};
  assign Add_sub_temp_7 = Add_8 - Add_v;
  assign Add_out1[7] = {Add_sub_temp_7[15:0], 16'b0000000000000000};
  ...
  highpass u_highpass (.clk(clk),
                       .reset(reset),
                       .enb(enb),
                       .In_0(Add_out1[0]),  // sfix32_En16
                       .In_1(Add_out1[1]),  // sfix32_En16
                       .In_2(Add_out1[2]),  // sfix32_En16
                       .In_3(Add_out1[3]),  // sfix32_En16
                       .In_4(Add_out1[4]),  // sfix32_En16
                       .In_5(Add_out1[5]),  // sfix32_En16
                       .In_6(Add_out1[6]),  // sfix32_En16
                       .In_7(Add_out1[7]),  // sfix32_En16
                       .Enable_out2(Enable),
                       .Out_0(highpass_out1_0),  // sfix32_En20
                       .Out_1(highpass_out1_1),  // sfix32_En20
                       .Out_2(highpass_out1_2),  // sfix32_En20
                       .Out_3(highpass_out1_3),  // sfix32_En20
                       .Out_4(highpass_out1_4),  // sfix32_En20
                       .Out_5(highpass_out1_5),  // sfix32_En20
                       .Out_6(highpass_out1_6),  // sfix32_En20
                       .Out_7(highpass_out1_7)  // sfix32_En20
                       );
  ...
  assign Add1_v = {2'b0, {Constant1_out1, 20'b00000000000000000000}};
  assign Add1_add_cast = {{6{highpass_out1[0][31]}}, highpass_out1[0]};
  assign Add1_add_temp = Add1_add_cast + Add1_v;
  assign Add1_out1[0] = Add1_add_temp[35:20];
  assign Add1_add_cast_1 = {{6{highpass_out1[1][31]}}, highpass_out1[1]};
  assign Add1_add_temp_1 = Add1_add_cast_1 + Add1_v;
  assign Add1_out1[1] = Add1_add_temp_1[35:20];
  assign Add1_add_cast_2 = {{6{highpass_out1[2][31]}}, highpass_out1[2]};
  assign Add1_add_temp_2 = Add1_add_cast_2 + Add1_v;
  assign Add1_out1[2] = Add1_add_temp_2[35:20];
  assign Add1_add_cast_3 = {{6{highpass_out1[3][31]}}, highpass_out1[3]};
  assign Add1_add_temp_3 = Add1_add_cast_3 + Add1_v;
  assign Add1_out1[3] = Add1_add_temp_3[35:20];
  assign Add1_add_cast_4 = {{6{highpass_out1[4][31]}}, highpass_out1[4]};
  assign Add1_add_temp_4 = Add1_add_cast_4 + Add1_v;
  assign Add1_out1[4] = Add1_add_temp_4[35:20];
  assign Add1_add_cast_5 = {{6{highpass_out1[5][31]}}, highpass_out1[5]};
  assign Add1_add_temp_5 = Add1_add_cast_5 + Add1_v;
  assign Add1_out1[5] = Add1_add_temp_5[35:20];
  assign Add1_add_cast_6 = {{6{highpass_out1[6][31]}}, highpass_out1[6]};
  assign Add1_add_temp_6 = Add1_add_cast_6 + Add1_v;
  assign Add1_out1[6] = Add1_add_temp_6[35:20];
  assign Add1_add_cast_7 = {{6{highpass_out1[7][31]}}, highpass_out1[7]};
  assign Add1_add_temp_7 = Add1_add_cast_7 + Add1_v;
  assign Add1_out1[7] = Add1_add_temp_7[35:20];
