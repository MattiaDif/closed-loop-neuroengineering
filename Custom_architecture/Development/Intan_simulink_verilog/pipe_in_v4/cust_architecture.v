// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\pipe_in_v4\cust_architecture.v
...
// Source Path: pipe_in_v4/cust_architecture
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module cust_architecture
  ...
  always @(posedge clk or posedge reset)
    begin : Delay_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          Delay_out1 <= pipe_in_interpret_out1;
        end
      end
    end
  ...
  assign pipe_out_data = Delay_out1;
