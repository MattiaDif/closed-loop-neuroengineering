// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v4\process_and_retrieve.v
...
// Source Path: CustArch_v4/cust_architecture/process_and_retrieve
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module process_and_retrieve
  ...
  reg  Memory2_out1;
  wire [15:0] bandpass_out1;  // uint16
  ...
  bandpass u_bandpass (.clk(clk),
                       .reset(reset),
                       .enb(enb),
                       .In(current_value),  // uint16
                       .Enable(Memory2_out1),
                       .Out(bandpass_out1)  // uint16
                       );

  // memory for saving AC filtered data in the right 
  // address
  always @(posedge clk or posedge reset)
