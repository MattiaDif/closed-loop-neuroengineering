// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v16\FIFO_filter.v
...
// 
// Module: FIFO_filter
// Source Path: CustArch_v16/cust_architecture/process_and_retrieve/FilterChip1/FIFO_filter
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module FIFO_filter
  ...
  SimpleDualPortRAM_generic #(.AddrWidth(2),
                            ...
                            u_FIFO_filter_ram_generic (.clk(clk),
                                                       .enb(enb),
                                                       .wr_din(In),
                                                       .wr_addr(w_waddr),
                                                       .wr_en(w_we),  // ufix1
