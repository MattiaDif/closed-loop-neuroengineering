// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v8\previous_sample_storage2.v
...
// Source Path: CustArch_v8/cust_architecture/process_and_retrieve/previous_sample_storage2
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module previous_sample_storage2
  ...
  always @(posedge clk or posedge reset)
    begin : Memory8_process
      if (reset == 1'b1) begin
        Memory8_out1 <= 10'b0000000000;
      end
      else begin
        if (enb) begin
          Memory8_out1 <= Switch_out1;
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : Memory9_process
      if (reset == 1'b1) begin
        Memory9_out1 <= 1'b0;
      end
      else begin
        if (enb) begin
          Memory9_out1 <= input_state_AC_TRUE_1;
        end
      end
    end
