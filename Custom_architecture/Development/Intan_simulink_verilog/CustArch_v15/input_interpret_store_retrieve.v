// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v15\input_interpret_store_retrieve.v
...
// Source Path: CustArch_v15/cust_architecture/input_interpret_store_retrieve
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module input_interpret_store_retrieve
  ...
  store_and_retrieve_input u_store_and_retrieve_input (.clk(clk),
                                                       ...
                                                       .current_value(current_value_1),  // uint16
                                                       .address_for_processing(wr_addr_1)  // ufix9
                                                       );
  ...
  assign device_output = Interpret_to_RAM_input_out1;

  assign address_for_processing = wr_addr_1;
