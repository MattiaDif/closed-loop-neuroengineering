// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v7\previous_sample_storage2.v
...
// Source Path: CustArch_v7/cust_architecture/process_and_retrieve/previous_sample_storage2
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module previous_sample_storage2
  ...
  input   reset;
  input   enb;
  input   signed [15:0] new_previous_sample;  // sfix16_E2
  input   input_state_AC_TRUE;
  input   [8:0] write_porcessing_addr_read_from_storage_addr_1;  // ufix9
  output  signed [15:0] previous_sample_0;  // sfix16_E2
  output  signed [15:0] previous_sample_1;  // sfix16_E2
  ...
  wire signed [15:0] PreviousData1_storage_out1;  // sfix16_E2
  wire signed [15:0] PreviousData1_storage_out2;  // sfix16_E2
  reg [9:0] Delay4_out1;  // ufix10
  reg  Delay5_out1;
  wire signed [15:0] PreviousData1_storage1_out1;  // sfix16_E2
  wire signed [15:0] PreviousData1_storage1_out2;  // sfix16_E2
