// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v21\cust_architecture.v
...
// Source Path: CustArch_v21/cust_architecture
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module cust_architecture
  ...
  wire enb_1_2_1;
  wire enb_1_1_1;
  wire [7:0] read_from_porcessing_addr;  // uint8
  ...
  cust_architecture_tc u_cust_architecture_tc (.clk(clk),
                                               .reset(reset),
  ...
  output_interpret u_output_interpret (.clk(clk),
                                       ...
                                       .InputState(read_from_porcessing_addr),  // uint8
  ...
  input_interpret_store_retrieve u_input_interpret_store_retrieve (.clk(clk),
                                                                   ...
                                                                   .read_from_processing_addr(read_from_porcessing_addr_2)  // ufix9
                                                                   );
