// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v23\cust_architecture.v
...
// Source Path: CustArch_v23/cust_architecture
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module cust_architecture
  ...
  pipe_in_interpret u_pipe_in_interpret (.clk(clk),
                                         ...
                                         .source_channel(source_channel),  // uint8
                                         .th(th),  // uint16
                                         .refractory_1(refractory)  // uint16
                                         );
