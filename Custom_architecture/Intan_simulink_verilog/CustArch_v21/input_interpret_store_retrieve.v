// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v21\input_interpret_store_retrieve.v
...
// Source Path: CustArch_v21/cust_architecture/input_interpret_store_retrieve
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module input_interpret_store_retrieve
  ...
  reg [7:0] read_from_porcessing_addr;  // uint8
  wire [15:0] store_and_retrieve_input_out1;  // uint16
  wire [15:0] read_from_porcessing_addr_1;  // uint16
  wire [8:0] read_from_porcessing_addr_2;  // ufix9
  ...
  always @(posedge clk or posedge reset)
    begin : Delay3_process
      if (reset == 1'b1) begin
        read_from_porcessing_addr <= 8'b00000000;
      end
      else begin
        if (enb) begin
          read_from_porcessing_addr <= InputState_1;
        end
      end
    end
  ...
  assign InputState = read_from_porcessing_addr;
  ...
  store_and_retrieve_input u_store_and_retrieve_input (.clk(clk),
                                                       ...
                                                       .current_value(read_from_porcessing_addr_1),  // uint16
                                                       .read_from_porcessing_addr(read_from_porcessing_addr_2)  // ufix9
                                                       );

  assign read_from_storage_value = store_and_retrieve_input_out1;

  assign current_value = read_from_porcessing_addr_1;

  assign read_from_processing_addr = read_from_porcessing_addr_2;
