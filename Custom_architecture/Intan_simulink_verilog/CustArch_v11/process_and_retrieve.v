...
module process_and_retrieve
  ...
  reg  write_en;
  wire signed [15:0] new_previous_sample;  // sfix16_E4
  wire signed [15:0] PreviousData1_storage_out1;  // sfix16_E4
  wire signed [15:0] previous_sample;  // sfix16_E4
  ...
  one_pole_IIR u_one_pole_IIR (.current_sample(current_value),  // uint16
                               .previous_sample(previous_sample),  // sfix16_E4
                               .filter_output(filter_output),  // uint16
                               .new_previous_sample(new_previous_sample)  // sfix16_E4
                               );
