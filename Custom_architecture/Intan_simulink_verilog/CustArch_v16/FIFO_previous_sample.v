// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v16\FIFO_previous_sample.v
...
// -------------------------------------------------------------
// 
// Module: FIFO_previous_sample
// Source Path: CustArch_v16/cust_architecture/process_and_retrieve/FilterChip1/FIFO_previous_sample
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module FIFO_previous_sample
  ...
  SimpleDualPortRAM_generic #(.AddrWidth(2),
                            ...
                            u_FIFO_previous_sample_ram (.clk(clk),
                                                        .enb(enb),
                                                        .wr_din(In),
                                                        .wr_addr(w_waddr),
                                                        .wr_en(w_we),  // ufix1
...
endmodule  // FIFO_previous_sample
