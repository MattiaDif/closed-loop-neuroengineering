...
MODEL                = HardThreshold
MODULES              = rt_logging.c HardThreshold.c HardThreshold_capi.c HardThreshold_data.c HardThreshold_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = HardThreshold.exe
MAKEFILE             = HardThreshold.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = D:/File/Shared/Google Drive/IIT - Neuroengineering/Project/WP1/Model
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = HardThreshold_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/HardThreshold \
