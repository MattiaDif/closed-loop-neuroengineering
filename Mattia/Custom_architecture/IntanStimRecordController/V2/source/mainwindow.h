...
private slots:
    ...
    //void highpassFilterLineEditChanged_CA(); // update GUI - SB - 05-04-2019
...
private:
    ...
    //void setHighpassFilterCutoff_CA(double cutoff); //update GUI - SB - 05-04-2019

    void setHardThreshold_CA(double th);    ////update GUI MD 03-09-2021
    ...
    //double highpassFilterFrequency_CA; // update GUI - SB - 05-04-2019
    ...
    //QLineEdit *highpassFilterLineEdit_CA; // update GUI - SB - 05-04-2019
