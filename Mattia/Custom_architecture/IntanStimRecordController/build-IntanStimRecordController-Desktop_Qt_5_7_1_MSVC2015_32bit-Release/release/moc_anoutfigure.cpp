...
void AnOutFigure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AnOutFigure *_t = static_cast<AnOutFigure *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AnOutFigure::staticMetaObject = {
    { &AbstractFigure::staticMetaObject, qt_meta_stringdata_AnOutFigure.data,
      qt_meta_data_AnOutFigure,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AnOutFigure::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AnOutFigure.stringdata0))
        return static_cast<void*>(const_cast< AnOutFigure*>(this));
