...
void TimeSpinBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TimeSpinBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TimeSpinBox::editingFinished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TimeSpinBox::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TimeSpinBox::valueChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (TimeSpinBox::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TimeSpinBox::trueValueChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject TimeSpinBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TimeSpinBox.data,
      qt_meta_data_TimeSpinBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
