...
void VoltageSpinBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (VoltageSpinBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VoltageSpinBox::editingFinished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (VoltageSpinBox::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VoltageSpinBox::valueChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (VoltageSpinBox::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VoltageSpinBox::trueValueChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject VoltageSpinBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VoltageSpinBox.data,
