...
void AbstractFigure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AbstractFigure *_t = static_cast<AbstractFigure *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AbstractFigure::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AbstractFigure.data,
      qt_meta_data_AbstractFigure,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AbstractFigure::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AbstractFigure.stringdata0))
        return static_cast<void*>(const_cast< AbstractFigure*>(this));
