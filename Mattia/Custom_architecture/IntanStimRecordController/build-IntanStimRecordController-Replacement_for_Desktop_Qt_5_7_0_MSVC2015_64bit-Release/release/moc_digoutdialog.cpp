...
void DigOutDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DigOutDialog *_t = static_cast<DigOutDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DigOutDialog::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DigOutDialog::highlightFirstPhaseDuration)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (DigOutDialog::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DigOutDialog::highlightPostTriggerDelay)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (DigOutDialog::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DigOutDialog::highlightPulseTrainPeriod)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (DigOutDialog::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DigOutDialog::highlightRefractoryPeriod)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject DigOutDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DigOutDialog.data,
      qt_meta_data_DigOutDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DigOutDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DigOutDialog.stringdata0))
        return static_cast<void*>(const_cast< DigOutDialog*>(this));
