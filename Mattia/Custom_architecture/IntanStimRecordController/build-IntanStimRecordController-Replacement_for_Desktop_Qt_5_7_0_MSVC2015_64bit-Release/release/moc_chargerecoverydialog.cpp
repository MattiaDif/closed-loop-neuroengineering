...
void ChargeRecoveryDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ChargeRecoveryDialog *_t = static_cast<ChargeRecoveryDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ChargeRecoveryDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ChargeRecoveryDialog.data,
      qt_meta_data_ChargeRecoveryDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ChargeRecoveryDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChargeRecoveryDialog.stringdata0))
        return static_cast<void*>(const_cast< ChargeRecoveryDialog*>(this));
