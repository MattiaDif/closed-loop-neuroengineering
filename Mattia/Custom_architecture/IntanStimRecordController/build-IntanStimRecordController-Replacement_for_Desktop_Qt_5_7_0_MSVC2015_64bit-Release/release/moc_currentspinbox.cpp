...
void CurrentSpinBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CurrentSpinBox *_t = static_cast<CurrentSpinBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CurrentSpinBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CurrentSpinBox::editingFinished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CurrentSpinBox::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CurrentSpinBox::valueChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (CurrentSpinBox::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CurrentSpinBox::trueValueChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject CurrentSpinBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CurrentSpinBox.data,
      qt_meta_data_CurrentSpinBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CurrentSpinBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CurrentSpinBox.stringdata0))
        return static_cast<void*>(const_cast< CurrentSpinBox*>(this));
