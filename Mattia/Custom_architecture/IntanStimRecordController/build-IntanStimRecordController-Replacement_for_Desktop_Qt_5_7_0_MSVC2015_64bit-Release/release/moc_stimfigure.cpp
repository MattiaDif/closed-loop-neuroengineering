...
void StimFigure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        StimFigure *_t = static_cast<StimFigure *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject StimFigure::staticMetaObject = {
    { &AbstractFigure::staticMetaObject, qt_meta_stringdata_StimFigure.data,
      qt_meta_data_StimFigure,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StimFigure::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StimFigure.stringdata0))
        return static_cast<void*>(const_cast< StimFigure*>(this));
