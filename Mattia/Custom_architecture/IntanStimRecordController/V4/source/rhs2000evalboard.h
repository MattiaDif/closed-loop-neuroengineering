...
public:
    ...
    void setCA_ConfigFile(unsigned int conf_data[3]);    //update GUI MD 14/09/2021
    ...
    void custom_architecture_Enable(bool cst_en);       // update GUI - SB - 05-04-2019
    void custom_architecture_trig_Enable(bool cst_trig_en);  // update GUI - SB - 05-04-2019
...
private:
    ...
    // Buffers for writing bytes to custom architecture
    unsigned char data_in[2];   //buffer of 2 bytes //update GUI MD 07-09-2021
    //unsigned char data_refractory[2];   //buffer of 2 bytes //update GUI MD 09-09-2021

    // end update GUI MD 03-09-2021
	...
	enum OkEndPoint {
        ...
        WireInDacReref = 0x0a,
        WireInCST_en = 0x0b,              // update GUI - SB - 05-04-2019
...
//      unused = 0x15,
        ...
        PipeInCustomArch = 0x88,    // update GUI - SB - 05-04-2019

        PipeOutData = 0xa0,
        PipeOutData_CA = 0xa1   // update GUI - SB - 05-04-2019
	};
