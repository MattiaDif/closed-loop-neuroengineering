// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v13\cust_architecture.v
...
// Source Path: CustArch_v13/cust_architecture
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module cust_architecture
  ...
  wire [15:0] current_value;  // uint16
  wire [7:0] input_interpret_store_retrieve_out4;  // uint8
  ...
  input_interpret_store_retrieve u_input_interpret_store_retrieve (.clk(clk),
                                                                   ...
                                                                   .device_output(input_interpret_store_retrieve_out4),  // uint8
                                                                   .address_for_processing(wr_addr)  // ufix9
                                                                   );
  ...
  process_and_retrieve u_process_and_retrieve (.clk(clk),
                                               ...
                                               .address_for_processing(wr_addr),  // ufix9
                                               .InputState(InputState),  // uint8
                                               .rd_address(collect_output_out3),  // ufix9
                                               .rd_out(process_and_retrieve_out1)  // uint16
                                               );
