// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v5\previous_sample_storage.v
...
// -------------------------------------------------------------
// 
// Module: previous_sample_storage
// Source Path: CustArch_v5/cust_architecture/process_and_retrieve/previous_sample_storage
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module previous_sample_storage
  ...
  input   reset;
  input   enb;
  input   signed [15:0] new_previous_sample;  // sfix16_En2
  input   input_state_AC_TRUE;
  input   [8:0] write_porcessing_addr_read_from_storage_addr_1;  // ufix9
  output  signed [15:0] previous_sample;  // sfix16_En2
  ...
  wire signed [15:0] PreviousData1_storage_out1;  // sfix16_En2
  wire signed [15:0] PreviousData1_storage_out2;  // sfix16_En2
  ...
  assign previous_sample = PreviousData1_storage_out2;

endmodule  // previous_sample_storage
