// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v12\process_and_retrieve.v
...
// Source Path: CustArch_v12/cust_architecture/process_and_retrieve
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module process_and_retrieve
  ...
  HardThreshold u_HardThreshold (.clk(clk),
                                 .reset(reset),
                                 .enb(enb),
                                 .filter_output(filter_output),  // uint16
