// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v20\input_interpret_store_retrieve.v
...
// Source Path: CustArch_v20/cust_architecture/input_interpret_store_retrieve
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module input_interpret_store_retrieve
  ...
  store_and_retrieve_input u_store_and_retrieve_input (.clk(clk),
                                                       ...
                                                       .read_from_porcessing_addr(wr_addr_1)  // ufix9
                                                       );
  ...
  assign read_from_processing_addr = wr_addr_1;
