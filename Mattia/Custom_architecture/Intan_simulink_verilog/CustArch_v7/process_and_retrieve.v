// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CustArch_v7\process_and_retrieve.v
...
// Source Path: CustArch_v7/cust_architecture/process_and_retrieve
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module process_and_retrieve
  ...
  reg signed [15:0] Delay2_out1 [0:1];  // sfix16_E2 [2]
  wire signed [15:0] new_previous_sample;  // sfix16_E2
  wire signed [15:0] previous_sample_0;  // sfix16_E2
  wire signed [15:0] previous_sample_1;  // sfix16_E2
  wire signed [15:0] previous_sample [0:1];  // sfix16_E2 [2]
  ...
  previous_sample_storage2 u_previous_sample_storage2 (.clk(clk),
                                                       .reset(reset),
                                                       .enb(enb),
                                                       .new_previous_sample(new_previous_sample),  // sfix16_E2
                                                       .input_state_AC_TRUE(input_state_AC_TRUE),
                                                       .write_porcessing_addr_read_from_storage_addr_1(read_from_processing_addr),  // ufix9
                                                       .previous_sample_0(previous_sample_0),  // sfix16_E2
                                                       .previous_sample_1(previous_sample_1)  // sfix16_E2
                                                       );
  ...
  always @(posedge clk or posedge reset)
    begin : Delay2_process
      if (reset == 1'b1) begin
        Delay2_out1[0] <= 16'sb0000000000000000;
        Delay2_out1[1] <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  digital_filter u_digital_filter (.clk(clk),
                                   ...
                                   .previous_sample_0(Delay2_out1[0]),  // sfix16_E2
                                   .previous_sample_1(Delay2_out1[1]),  // sfix16_E2
