// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\pipe_in_v3\cust_architecture.v
...
// Source Path: pipe_in_v3/cust_architecture
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module cust_architecture
  ...
  pipe_in_interpret u_pipe_in_interpret (.clk(clk),
                                         .reset(reset),
                                         .enb(clk_enable),
                                         .pipe_in_data(pipe_in_data),  // uint16
                                         .pipe_in_en(Constant4_out1),
                                         .pipe_in(pipe_in_interpret_out1),  // uint16
                                         .PipeInState(PipeInState)  // uint8
                                         );

  process_and_retrieve u_process_and_retrieve (.value_from_pipeIn(pipe_in_interpret_out1),  // uint16
