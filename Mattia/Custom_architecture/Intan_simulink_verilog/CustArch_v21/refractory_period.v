...
module refractory_period
  ...
  assign read_from_porcessing = rd_addr == 9'b000000001;
  ...
  always @(posedge clk or posedge reset)
    begin : Delay_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          Delay_out1 <= write_porcessing_addr_read_from_storage_addr_4;
        end
      end
    end
  ...
  DualPortRAM_generic #(.AddrWidth(9),
                      ...
                      u_timestamp_before (.clk(clk),
                                          ...
                                          .wr_addr(Delay_out1),
                                          .wr_en(wr_en),
                                          .rd_addr(write_porcessing_addr_read_from_storage_addr_4),
