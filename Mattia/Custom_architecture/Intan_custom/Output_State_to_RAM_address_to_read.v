// -------------------------------------------------------------
// 
// File Name: C:\GitHub\closed-loop-neuroscience\Mattia\Custom_architecture\Verilog\CustArch\Output_State_to_RAM_address_to_read.v
...
// Source Path: CustArch/cust_architecture/output_interpret/Interpret_to_RAM_output/Output State to RAM address (to 
// read
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Output_State_to_RAM_address_to_read
  ...
  wire AND2_out1;
  wire Switch12_out1;
  wire Needs_to_be_the_right_moment_for_the_output_out1;
  ...
  assign Needs_to_be_the_right_moment_for_the_output_out1 = OutputState == 8'b00010000;



  assign switch_compare_1_2 = Needs_to_be_the_right_moment_for_the_output_out1 > 1'b0;
  ...
  assign state_TTL_in1_out1 = OutputState == 8'b00001111;



  assign switch_compare_1_3 = state_TTL_in1_out1 > 1'b0;
  ...
  assign state_TTL_in_out1 = OutputState == 8'b00001110;



  assign switch_compare_1_4 = state_TTL_in_out1 > 1'b0;
  ...
  assign Bit_Concat1_out1 = {source_channel, Constant1_out1};
  ...
  assign Bit_Concat_out1 = {source_channel, Constant_out1};
