// -------------------------------------------------------------
// 
// File Name: C:\GitHub\closed-loop-neuroscience\Mattia\Custom_architecture\Verilog\CustArch\read_from_magic_and_timestamp.v
...
// Source Path: CustArch/cust_architecture/collect_output/read_from_magic_and_timestamp
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module read_from_magic_and_timestamp
  ...
  DualPortRAM_generic #(.AddrWidth(8),
                      ...
                      u_input_RAM_for_MagicNumber_TimeStamps (.clk(clk),
                                                              ...
                                                              .rd_addr(read_address_output_state),
