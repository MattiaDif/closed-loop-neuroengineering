...
#endif
static const char *ng0 = "C:/GitHub/intan_custom_arch/FPGA/New code/Working_project_from_simulink/RHS2000InterfaceXEM6010 release 180814_cust_arch/cust_spike_detect_0.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
