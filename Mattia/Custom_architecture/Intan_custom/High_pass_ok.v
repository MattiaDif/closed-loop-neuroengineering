// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\cust_arch_16\High_pass_ok.v
// Created: 2019-09-02 11:05:08
// 
...
// 
// Module: High_pass_ok
// Source Path: cust_arch_16/cust_architecture/one_pole_IIR/High_pass_ok
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module High_pass_ok
  ...
  wire signed [15:0] s_1_out1;  // sfix16_En12
  ...
  wire signed [33:0] SumB21_sub_cast;  // sfix34_En31
  wire signed [33:0] SumB21_sub_cast_1;  // sfix34_En31
  ...
  assign SumA21_sub_cast = {s_1_out1, 18'b000000000000000000};
  ...
  assign SumB21_sub_cast = {{2{CastState1_out1[15]}}, {CastState1_out1, 16'b0000000000000000}};
  assign SumB21_sub_cast_1 = {{2{Input1[15]}}, {Input1, 16'b0000000000000000}};
