// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\cust_arch_14\interpreting_from_DC_to_state_charge.v
...
// -------------------------------------------------------------
// 
// Module: interpreting_from_DC_to_state_charge
// Source Path: cust_arch_14/cust_architecture/interpret data/interpreting_from_DC_to_state_charge
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module interpreting_from_DC_to_state_charge
  ...
  assign Compare_To_Constant1_out1 = input_state == 8'b00000000;
  ...
  assign Compare_To_Constant4_out1 = input_state >= 8'b00001000;



  assign Compare_To_Constant3_out1 = input_state == 8'b00000110;



  assign Compare_To_Constant6_out1 = input_state <= 8'b00001011;
  ...
  assign AND_out1 = write_to & OR_out1;
  ...
  assign Compare_To_Constant2_out1 = input_state == 8'b00001101;
  ...
  //  count to value  = 20
  always @(posedge clk or posedge reset)
    begin : count_dev_output_process
      if (reset == 1'b1) begin
  ...
  getting_source_channel_0_159 u_getting_source_channel_0_159 (.clk(clk),
                                                               .reset(reset),
                                                               .enb(enb),
  ...
  assign incoming_source_dev = AND2_out1;

endmodule  // interpreting_from_DC_to_state_charge
