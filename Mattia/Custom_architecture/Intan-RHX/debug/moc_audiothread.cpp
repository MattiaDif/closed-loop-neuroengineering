...
#include "../Engine/Threads/audiothread.h"
...
QT_MOC_LITERAL(1, 12, 10), // "newChannel"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4), // "name"
QT_MOC_LITERAL(4, 29, 10) // "catchError"

    },
    "AudioThread\0newChannel\0\0name\0catchError"
};
...
void AudioThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newChannel((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->catchError(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AudioThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AudioThread::newChannel)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioThread::newChannel(QString _t1)
{
