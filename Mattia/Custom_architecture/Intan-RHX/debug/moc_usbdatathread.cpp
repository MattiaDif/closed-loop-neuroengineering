...
#include "../Engine/Threads/usbdatathread.h"
...
QT_MOC_LITERAL(1, 14, 18), // "hardwareFifoReport"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 11) // "percentFull"

    },
    "USBDataThread\0hardwareFifoReport\0\0"
    "percentFull"
};
...
void USBDataThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<USBDataThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hardwareFifoReport((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (USBDataThread::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&USBDataThread::hardwareFifoReport)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void USBDataThread::hardwareFifoReport(double _t1)
{
