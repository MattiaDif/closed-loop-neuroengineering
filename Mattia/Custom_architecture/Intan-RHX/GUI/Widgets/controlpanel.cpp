...
#include "MD_controlpanelcustomenabletab.h"  //update GUI MD 27/07/21
    ...
    timeScaleComboBox(nullptr)
{
    ...
    // start update GUI MD 27/07/21
    customarchTab = new ControlPanelCustomArchitectureTab(controllerInterface, state, this);
    state->writeToLog("Created customArch");
    // end update GUI MD 27/07/21
    ...
    tabWidget->addTab(customarchTab, tr("Custom")); //update GUI MD 27/07/21
