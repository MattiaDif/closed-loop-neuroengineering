...
%% Parameter setting
data_stream_enable = [0 0 0 1 0 0 0 0]; %data stream enable rollmap
...
%% Loading data
%raw input
load(['C:\Users\diflo\OneDrive - Fondazione Istituto Italiano Tecnologia\IIT\Progetto MathWorks\Debugging_IO_files\In_Out_Simulink\In\invivo_raw_fsm_out_chip',chip(find(~isspace(chip))),'_nframe',frame,'.mat'])

% load('raw_fsm_valid_chip10000000_nframe300.mat')


%input
load(['C:\Users\diflo\OneDrive - Fondazione Istituto Italiano Tecnologia\IIT\Progetto MathWorks\Debugging_IO_files\In_Out_Simulink\In\invivo_fsm_out_chip',chip(find(~isspace(chip))),'_nframe',frame,'.mat'])
fsm_out_def_time = fsm_out_def_time.Data;

load(['C:\Users\diflo\OneDrive - Fondazione Istituto Italiano Tecnologia\IIT\Progetto MathWorks\Debugging_IO_files\In_Out_Simulink\In\invivo_fsm_valid_chip',chip(find(~isspace(chip))),'_nframe',frame,'.mat'])
fsm_valid_def_time = fsm_valid_def_time.Data;


%output
load(['C:\Users\diflo\OneDrive - Fondazione Istituto Italiano Tecnologia\IIT\Progetto MathWorks\Debugging_IO_files\In_Out_Simulink\Out\invivo_custv',num2str(cust_version),...
