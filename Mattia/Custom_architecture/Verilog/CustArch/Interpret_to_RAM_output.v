// -------------------------------------------------------------
// 
// File Name: C:\GitHub\closed-loop-neuroscience\Mattia\Custom_architecture\Verilog\CustArch\Interpret_to_RAM_output.v
...
// Source Path: CustArch/cust_architecture/output_interpret/Interpret_to_RAM_output
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Interpret_to_RAM_output
  ...
  get_enabled_timings u_get_enabled_timings (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
                                             .output_state(read_address_output_state),  // uint8
                                             .data_stream_en(data_stream_en),  // uint8
                                             .source_channel_en(get_enabled_timings_out1),
                                             .source_ch_0_159(source_channel),  // uint8
  ...
  Output_State_to_RAM_address_to_read u_Output_State_to_RAM_address_to_read (.source_channel_en(get_enabled_timings_out1),
                                                                             ...
                                                                             .OutputState(read_address_output_state),  // uint8
