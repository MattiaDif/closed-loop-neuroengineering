// -------------------------------------------------------------
// 
// File Name: C:\GitHub\closed-loop-neuroscience\Mattia\Custom_architecture\Verilog\CustArch\Input_State_to_RAM_address_to_write.v
...
// -------------------------------------------------------------
// 
// Module: Input_State_to_RAM_address_to_write
// Source Path: CustArch/cust_architecture/input_interpret_store_retrieve/Interpret_to_RAM_input/Input State to RAM 
// address (to write
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Input_State_to_RAM_address_to_write
  ...
  // chiedere address ram? numeri a caso?


  assign wr_din = DataIn;

  assign state_TTL_in1_out1 = InputState == 8'b00001111;



  assign switch_compare_1 = state_TTL_in1_out1 > 1'b0;
  ...
  assign state_TTL_in_out1 = InputState == 8'b00001110;



  assign switch_compare_1_1 = state_TTL_in_out1 > 1'b0;
...
endmodule  // Input_State_to_RAM_address_to_write
