// -------------------------------------------------------------
// 
// File Name: C:\GitHub\closed-loop-neuroscience\Mattia\Custom_architecture\Verilog\CustArch\cust_architecture.v
...
// Source Path: CustArch/cust_architecture
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module cust_architecture
  ...
  wire [15:0] pipe_in_interpret_out1;  // uint16
  ...
  pipe_in_interpret u_pipe_in_interpret (.clk(clk),
                                         .reset(reset),
                                         .enb(clk_enable),
                                         .In1(pipe_in_data),  // uint16
                                         .Out1(pipe_in_interpret_out1)  // uint16
                                         );
  ...
  collect_output u_collect_output (.clk(clk),
                                   ...
                                   .read_from_storage_post(collect_output_out2),  // uint16
