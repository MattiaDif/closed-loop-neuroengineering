// -------------------------------------------------------------
// 
// File Name: C:\GitHub\closed-loop-neuroscience\Mattia\Custom_architecture\Verilog\CustArch\get_sources.v
...
// 
// Module: get_sources
// Source Path: CustArch/cust_architecture/input_interpret_store_retrieve/Interpret_to_RAM_input/interpret data/get_sources
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module get_sources
  ...
  // perchè non mi frega
  // che sia AC o DC,
  // sto solo identificando
  // le sorgenti
  // 
  // identifichi chip che stai leggendo
  // 
